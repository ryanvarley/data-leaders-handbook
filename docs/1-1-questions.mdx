...
title: 1:1 Meeting Questions
description: Great questions to elevate your 1:1 meetings and build trust.
...
There is a [companion post](https://blog.dataleadership.ai/p/great-one-on-one-meeting-questions) that shares more about how to use this guide and general advice on running 1:1 meetings.
...
### Is there anything on your mind? {#is-there-anything-on-your-mind}
...
### What's my biggest challenge in / to [subject]?

To be used when you have a big known problem you are trying to solve. E.g. in improving team morale, in hitting our goals etc
...
Especially for managers or tech leads, but it can apply to everyone.

People often have something they know they need to do, but don’t want to face. This can drag things out.

For example:

* Go ahead with the decision on X, despite Y not liking it
* Have a difficult performance conversation
* Go back to being an IC / previous role
* Raise a big issue with a peer or manager
* Try a risky project

Now you can mentor them through this.
...
### Is there anything you would like us to use this meeting for in future? ★ {#is-there-anything-you-would-like-us-to-use-this-meeting-for-or-would-like-to-go-over-in-this-meeting-in-future-}
...
This draws out that thing in the back of their mind.

* Go ahead with the decision on X despite Y not liking it
* Let Z go from the team
