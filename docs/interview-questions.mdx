...
Here is my list of interview questions to ask candidates during your hiring process. This isnt my full process or the only things I ask. More on that anther time.
...
Very few of these questions are intended to be asked in isolation. They start a conversation and should be followed up. A follow up is generally a gentle "why?" e.g. "Thats interesting, did you try x?" "how did you solve for z?", "I have found that with standups too, but as a remote team how did you stay connected?"

If you foudn this useful, consider subscribing to Data Leadership for updates about content here, and more content about leading data teams.
