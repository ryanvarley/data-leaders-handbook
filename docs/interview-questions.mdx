...
Questions in this section are mutli-part as follow ups are essential. Competence is about deep understanding. Bad competence questions will allow candidates to sail through with surface knowledge giving you a fake sense of security.  

This is not the only way I test competence, their will be an article on this soon (subscribe for updates).
...
**It is very important to dig into the details and not ask this in isolation.** Its probably 15-20m and a key part of my hiring manager interview (after phone screen). I say "proud of" as they should have had deep involvement, and still remember the details. It makes the project their choice and gives them little room to not be able to talk about it.
...
Common asked to data scientists taking about a machine learning project. e.g. Why random forrest?

#### What are the advantages of X method over Y method?

e.g. Why did you use a document store over a relational db?

#### How does X method work?

I dont expect mathmatical derivations but they should have an idea of how a fundamental technology to the project. I sometimes describe this like a racing car driver and the engineers who build the car. I expect them to be the driver, with a deep understanding of how it behaves and how to use it, but not be ale to build the engine themselves.
...
Either extreme is generally bad but im looking for rather than a rigid view there view is fleixble and dependent on circumstances. You surface a lot of their values here.
...
For example:
* You've used MongoDB a lot? When have you found it to be a better choice over SQL? Some of our older infra is on Mongo, and we've had to recreate a lot of relational logic in the application code.
